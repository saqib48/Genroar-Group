...
const CoinSecion = () => {
  return (
    <div className='relative w-[100%] my-[100px] px-[70px]  py-[50px] 2xl:flex 2xl:flex-nowrap 2xl:justify-between xl:flex xl:flex-nowrap xl:justify-between lg:flex lg:flex-nowrap lg:justify-between md:flex md:flex-wrap md:justify-start sm:flex sm:flex-wrap sm:justify-start flex flex-wrap justify-start'>
