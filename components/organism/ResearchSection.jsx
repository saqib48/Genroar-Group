...
const ResearchSection = () => {
  return (
    <div className='w-[100%] 2xl:flex 2xl:flex-nowrap 2xl:justify-between 2xl:px-[70px] xl:flex xl:flex-nowrap xl:justify-between xl:px-[70px] lg:flex lg:flex-nowrap lg:justify-between lg:px-[70px] md:flex md:flex-wrap-reverse md:justify-between md:px-[50px] sm:flex sm:flex-wrap-reverse sm:justify-start sm:px-[20px] flex flex-wrap-reverse justify-between px-[100px]  '>
