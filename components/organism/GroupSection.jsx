...
const GroupSection = () => {
  ...
  return (
    <div className=' pb-[50px] px-[70px] w-[100%]'>
      <div className="flex flex-col">
        <div className='2xl:py-[50px] xl:py-[50px] lg:py-[50px] md:py-[20px] sm:pb-[10px] pb-[20px] gap-[20px] order-2 flex flex-col  items-start sm:flex-row sm:order-2 sm:gap-[20px] sm:items-start sm:justify-center md:flex-col md:items-start md:order-2 md:gap-[20px] md:justify-between  xl:flex-row  xl:items-center xl:justify-between xl:order-1  2xl:flex-row 2xl:items-center 2xl:order-1 2xl:justify-between '>
          <Counterbox />
          <Counterbox2 />
          <CounterBox3 />
          <CountBox4 />
