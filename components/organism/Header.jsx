...
const Header = () => {
  ...
  return (
    <div className='capitalize px-[70px] border-b-2 border-[#99] flex justify-between  w-[100%] z-[1000]' data-aos="fade-down">
      ...
      <div className=" flex gap-[20px]">
        <div className="tag">
          <ul className='xl:flex xl:flex-nowrap xl:items-center xl:justify-center xl:gap-[50px] lg:flex lg:items-center lg:justify-center lg:gap-[50px] md:hidden sm:hidden hidden'>
        ...
        <div className='hover:cursor-pointer  xl:justify-center  lg:flex lg:justify-center lg:items-center bg-gradient-to-r from-gray-900 via-white-900 to-gray-900 mt-[10px] rounded-[5px] w-[130px] h-[50px] xl:block xl:items-center md:hidden hidden'>
