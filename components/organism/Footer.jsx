...
const Footer = () => {
  return (
    <div className=' border-t-2 border-[#d1d8dd]  w-[100%] 2xl:flex  2xl:flex-nowrap xl:flex xl:flex-nowrap lg:flex lg:flex-nowrap md:flex md:flex-wrap sm:flex sm:flex-wrap flex flex-wrap '>
